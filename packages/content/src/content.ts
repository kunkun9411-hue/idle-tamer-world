...
export const MONSTERS: MonsterDefinition[] = [
  ...
  },
  {
    ...
    evolution: { name: "Groveguard", species: "Hainwächter", role: "Unbeugsamer Tank", baseHp: 285, baseAttack: 25, accent: "#54c78a", glyph: "GG", description: "Ein lebender Schutzwall aus uraltem Holz, Moos und gespeicherten Erinnerungen.", sprite: "/assets/monsters/evolutions/mossbit/mossbit_groveguard_idle_right.png", nativeFacing: "right" },
  },
  {
    ...
    evolution: { name: "Stormray", species: "Gewitterrochen", role: "Schneller Artillerist", baseHp: 184, baseAttack: 43, accent: "#f4ca39", glyph: "ST", description: "Breitet elektrische Flügel aus und reitet auf den Magnetfeldern der Ether-Welt.", sprite: "/assets/monsters/evolutions/voltfin/voltfin_stormray_idle_right.png", nativeFacing: "right" },
  },
  {
    ...
    evolution: { name: "Abysshorn", species: "Tiefseebock", role: "Brecher", baseHp: 248, baseAttack: 34, accent: "#4da7e8", glyph: "AH", description: "Panzerplatten und Strömungshörner machen jeden Ansturm zu einer Flutwelle.", sprite: "/assets/monsters/evolutions/tideram/tideram_abysshorn_idle_right.png", nativeFacing: "right" },
  },
  {
