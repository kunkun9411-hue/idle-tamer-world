...
function guildView(): string {
  ...
  if (!membership) {
    ...
    return `<section class="page guild-page">${pageHeading("SERVERAUTORITATIV · ONLINE", "Finde deine Gilde", "Gründe eine eigene Gemeinschaft oder tritt einer offenen Gilde bei. Mitgliedschaft, Rollen und Ressourcen liegen ausschließlich in PostgreSQL.", `${guildSnapshot.directory.length} GILDEN SICHTBAR`)}
