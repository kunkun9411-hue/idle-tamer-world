# Roadmap-A/B-UI-Übergabe an Roadmap C

Status: **Roadmap A 32/32 eingefroren · Roadmap B 32/32 eingefroren · Roadmap C aktiv**
...
Alle 32 Gates von Roadmap B sind abgeschlossen. Die finale
Live-Spielerabnahme erfolgte am **30.07.2026** gegen
`5820733c5dab4dfc8e35d411574e2b8491aafd15`; siehe
[Roadmap-B-Live-Abnahme](ROADMAP_B_LIVE_ACCEPTANCE_2026-07-30.md).
Roadmap B ist damit eingefroren.
Roadmap C ist der aktive Arbeitsabschnitt.
...
| Was ist der maßgebliche Roadmap-B-Status? | `apps/web/public/roadmap/roadmap-status.json` (32/32, abgeschlossen und eingefroren) |
| Wie wurden B.02–B.08 abgeschlossen? | `B02_B08_PROGRESS.md` und `ROADMAP_B_LIVE_ACCEPTANCE_2026-07-30.md` |
...
## Eingefrorener UI-Änderungsablauf
...
7. erst dann das jeweilige Gate der aktiven Roadmap abhaken.

Roadmap B wurde nach dieser Prüfkette in
`apps/web/public/roadmap/roadmap-status.json` und
`docs/ROADMAP_B_DESIGN_UI.md` synchron auf 32/32 geschlossen. Der Ablauf ist
für Roadmap C und spätere UI-Erweiterungen wiederzuverwenden.
...
Historischer Vorabnachweis: `pnpm check:all`, `pnpm ui:audit` und
`pnpm ui:capture` waren grün. Der damalige Vollcheck umfasste 67 Web-, 24 API-,
11 Datenbank-Unit-, 6 Core- und 53 lokale Browsertests. Die anschließend
durchgeführte credentialgebundene Live-Spielerabnahme schloss B.03 und B.08
am **30.07.2026**; maßgeblich ist der
[finale Live-Nachweis](ROADMAP_B_LIVE_ACCEPTANCE_2026-07-30.md) für
`5820733c5dab4dfc8e35d411574e2b8491aafd15`.
